"""Evaluate SVGD step sizes visually and across multiple random seeds."""
...
def main() -> None:
    ...
    # SVGD is deterministic after initialization, so changing the seed changes
    ...
    particle_path = output_directory / "svgd_stepsize_2d.png"
    particle_figure.savefig(particle_path, dpi=180, bbox_inches="tight")

    # Figure 2 summarizes mean and standard deviation across all seeds.
    ...
    summary_figure.suptitle(f"SVGD step-size evaluation across {n_seeds} seeds")
    summary_figure.tight_layout()
    summary_path = output_directory / "svgd_stepsize_summary_2d.png"
